  ...
  const mailOptions = {
    ...
    html: `
      ...
      <div style="max-width: 650px; margin: 0 auto; background-color: #ffffff; padding: 40px; border-radius: 10px; box-shadow: 0 0 20px rgba(0, 0, 0, 0.1);">
        <div style="background-color: #ff6600; color: white; text-align: center; padding: 20px; border-radius: 10px 10px 0 0;">
        ...
        <a href="https://dogobiscuits.online/order/${orderDetails.orderNumber}" style="display: inline-block; padding: 12px 30px; background-color: #ff6600; color: white; text-decoration: none; font-size: 16px; border-radius: 5px; margin-top: 20px;">View Your Order</a>

        <div style="text-align: center; font-size: 14px; color: #777; margin-top: 30px;">
            <p>If you have any questions, feel free to <a href="mailto:dogobuscuits@gmail.com" style="color: #ff6600;">contact us</a>.</p>
